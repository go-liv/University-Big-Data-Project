try
cfile = 'W_fr-meteofrance,MODEL,MATCH+FORECAST+SURFACE+O3+0H24H_C_LFPW_20180701000000.nc';
...
portugalO3Match = (northMean + centreMean + southMean)/3;
catch
    ErrorMessage = 'Error calculating means.';
end